...
public class GetDietService {

    public static String getDietList(String keyword) throws IOException {
        String serviceUrl = "http://apis.data.go.kr/1471000/FoodNtrIrdntInfoService1/getFoodNtrItdntList1";
        String key = "=9a7z2tepZIlPKtex2BiRQPlJygPjtiID0FkjKx8RinLlBN%2B7FOigH4kFfVsMUjXKmqN4sHVA76Z6rZwkoUsoJQ%3D%3D";
